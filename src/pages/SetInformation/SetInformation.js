...
const SetInformation = () => {
  ...
  return ( <
    ...
    Container >
    <
    h4 className = "text-success styled-heading" > Welcome!{
      user ? .displayName ? user ? .displayName : name
    } < /h4> <
    p >
    Hello < span className = 'text-success' > {
      user ? .displayName ? user ? .displayName : name
    } < /span>! You have successfully registred. Now you should set some basic information about you. Please sincerely fill up the below fileds. <
    /p>
    ...
    type = "text"
    placeholder = "Villege, Road no/ House no, upozila" / >
    <
    /Form.Group>  <
    Form.Group as = {
      Col
