      ...
      <Container className='border py-3'>
          ...
          <Form onSubmit={handleSubmit(publishEvent)}>
            <Form.Group as={Col} className="mb-3" controlId="formBasicEmail">
              ...
              <Form.Control className='shadow-none transparent-field text-light' {...register("eventTitle", {required : true})} type="text" placeholder="Event title" />
            </Form.Group>
            ...
            <Row>
              <Form.Group md="6" as={Col} className="mb-3" controlId="formBasicEmail">
                ...
                <Form.Control className='shadow-none transparent-field text-light' {...register("eventDate", {required : true})} type="date" placeholder="Event date" />
              </Form.Group>

              <Form.Group md="6" as={Col} className="mb-3" controlId="formBasicEmail">
                <Form.Label className='small text-light'>Event Place:</Form.Label>
                <Form.Control className='shadow-none transparent-field text-light' {...register("eventPlace", {required : true})} type="text" placeholder="Event Place" />
              </Form.Group>
            </Row>
            ...
            <Row>
              <Form.Group md="6" as={Col} className="mb-3" controlId="formBasicEmail">
                ...
                <Form.Control className='shadow-none transparent-field text-white' {...register("eventStart", {required : true})} type="time" placeholder="Event start time" />
              </Form.Group>

              <Form.Group md="6" as={Col} className="mb-3" controlId="formBasicEmail">
                <Form.Label className='small text-light'>End Time:</Form.Label>
                <Form.Control className='shadow-none transparent-field text-white' {...register("eventEnd", {required : true})} type="time" placeholder="Event end time" />
              </Form.Group>
            </Row>

            <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
              <Form.Label className='small text-light'>Event Description:</Form.Label>
              <Form.Control className='shadow-none transparent-field text-light' as="textarea" {...register("eventBody", {required : true})} rows={3} placeholder="Write Event Body" />
            </Form.Group>
            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
              ...
              <Form.Control className='shadow-none transparent-field text-light' as="textarea" {...register("eventContent", {required : true})} rows={3} placeholder="Write Event Body" />
            </Form.Group>

            <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
              <Form.Label className='small text-light'>Event Image Link:</Form.Label>
              <Form.Control className='shadow-none transparent-field text-light' {...register("eventImage", {required : true})} type="text" placeholder="Event image link" />
            </Form.Group>
